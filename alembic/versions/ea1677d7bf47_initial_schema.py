...
def upgrade() -> None:
    ...
    sa.Column('age', sa.SmallInteger().with_variant(sa.Integer(), 'sqlite'), nullable=False, comment='환자 나이'),
    ...
    sa.Column('id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), autoincrement=True, nullable=False),
    sa.Column('patient_id', sa.BigInteger().with_variant(sa.Integer(), 'sqlite'), nullable=False, comment='환자 정보 테이블 FK'),
